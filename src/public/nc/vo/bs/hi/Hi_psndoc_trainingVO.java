 ...
 * @Description:  员工培训信息
 * @项目名称: fbsjt
 * @文件名称: Hi_psndoc_trainingVO.java
 * @Author: 王凯强
 * @Date: 2016年7月28日下午3:21:55
 */
public class Hi_psndoc_trainingVO extends SuperVO {
...
//	}
	...
	public void setTra_cost(UFDouble tra_cost) {
	...
	public UFDouble getTra_score() {
		return tra_score;
	}
	public void setTra_score(UFDouble tra_score) {
		this.tra_score = tra_score;
	}
	public UFDouble getTra_time() {
		return tra_time;
	}
	public void setTra_time(UFDouble tra_time) {
