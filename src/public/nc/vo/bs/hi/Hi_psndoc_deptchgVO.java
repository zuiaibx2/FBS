...
/**
 * @ClassName: Hi_psndoc_deptchgVO
 * @Description:  员工任职信息
 * @项目名称: fbsjt
 * @文件名称: Hi_psndoc_deptchgVO.java
 * @Author: 王凯强
 * @Date: 2016年7月28日上午9:34:02
 */
public class Hi_psndoc_deptchgVO extends SuperVO{

	private static final long serialVersionUID = 8685431480338297785L;
