...
/**
 * @ClassName: Hi_psndoc_grpdef14VO
 * @Description:  家庭成员海外背景信息
 * @项目名称: fbsjt
 * @文件名称: Hi_psndoc_grpdef14VO.java
 * @Author: 王凯强
 * @Date: 2016年7月28日下午2:07:23
 */
public class Hi_psndoc_grpdef14VO extends SuperVO {
	private static final long serialVersionUID = -3326895463660548476L;
